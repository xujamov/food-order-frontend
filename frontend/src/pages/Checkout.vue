...
export default {
    ...
    methods: {
        ...
        async getAllCartItem() {
            if (this.user) {
                let existItem = await AxiosService.get('/cartItem/' + this.user.user_id);
        ...
        async sendBillDetails(billId, foodId, qty) {
            ...
            await AxiosService.post("/billdetails", billDetails);
        },
        ...
        async handleSubmit(e) {
            ...
            if (!this.checkEmptyErr()) {
                ...
                e.preventDefault();
                let billId = (await AxiosService.get("/billstatus/new")).data;
                ...
                AxiosService.post("/billstatus", billStatus);
                AxiosService.delete("/cartItem/" + this.user.user_id);
