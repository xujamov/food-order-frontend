...
export default {
    ...
    methods: {
        ...
        async onQtyChange(e, i) {
            ...
            await AxiosService.put("/cartItem/", data)
        },

        async cancelBtn() {
            await AxiosService.delete("/cartItem/" + this.user.user_id);
        ...
        async removeBtn(index) {
            await AxiosService.delete("/cartItem/" + this.user.user_id + "/" + this.cartItem[index]);
