                ...
                <div class="row box-container">
                    <div v-for="(f, index) in currentPageItems" :key="index">
                        <div class="box">
                            ...
                            <div class="image">
                                <img :crossorigin="anonymous" :src="`https://restaurant-ordering-system.onrender.com/api/image/${f.food_src}`" alt="" />
                            </div>
                            <div class="content">
                                <h3>{{ f.food_name }}</h3>
                                <div class="stars">
    ...
    computed: {
        ...
        filterFoods: function () {
            return this.allFoods.filter((f) => f.food_name.toLowerCase().match(this.foodObj.name.toLowerCase()) &&
                (f.category_name.match(this.foodObj.category) || this.foodObj.category == "all" || this.foodObj.category == "") &&
