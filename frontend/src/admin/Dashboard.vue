...
export default {
  ...
  methods: {
    ...
    async getAllBills() {
        ...
        await AxiosService.get('/billstatus').then((res) => {
    ...
    async nextStatusBtn(id) {
      await AxiosService.put('/billstatus/' + id);
      this.getAllBills();
    },

    async paidBtn(id) {
      await AxiosService.put('/billstatus/paid/' + id);
      this.getAllBills();
    },

    async cancelBtn(id) {
      await AxiosService.put('/billstatus/cancel/' + id);
      this.getAllBills();
    },
